...
// GET /api/v1/domains
export async function getAllDomains(req, res, next) {
...
export async function getDomainsByDept(req, res, next) {
    ...
    try {
        ...
        return res
            .status(200)
            .json(new ApiResponse(200, result.rows, `Domains for ${deptAbbreviation} fetched successfully`));
    }
    catch (error) {
