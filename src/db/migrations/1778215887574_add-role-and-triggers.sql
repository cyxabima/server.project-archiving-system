...
DROP TRIGGER IF EXISTS set_industry_id ON industry;
DROP FUNCTION IF EXISTS generate_industry_id();

DROP TRIGGER IF EXISTS set_project_id ON projects;
DROP FUNCTION IF EXISTS generate_project_id();

DROP TRIGGER IF EXISTS set_domain_id ON domains;
DROP FUNCTION IF EXISTS generate_domain_id();
