...
export async function createGroup(req: Request, res: Response, next: NextFunction) {
    ...
    try {
        ...
        const insertQuery = `
            ...
            RETURNING *;
        `;
        const result = await pool.query(insertQuery, [groupLeader, member2 || null, member3 || null, member4 || null, projectId || null]);
...
export async function updateGroup(req: Request, res: Response, next: NextFunction) {
    ...
    try {
        ...
        const updateQuery = `
            ...
            RETURNING *;
        `;
        const result = await pool.query(updateQuery, [groupLeader, member2, member3, member4, projectId, groupId]);
